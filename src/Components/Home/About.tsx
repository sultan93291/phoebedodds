    ...
    <section>
      <Container className="xl:py-[100px] py-12 border-b border-[#B1B1B1] 2xl:px-0 px-5">
        <div className="flex flex-col md:flex-row gap-10">
          <h3
            className="font-inter xl:text-[32px] lg:text-[25px] text-[20px] font-semibold text-[#000] w-full md:w-1/3"
            data-aos="fade-right"
          >
            About Us
          </h3>
          <div className="md:w-2/3" data-aos="fade-left">
            <p className="font-inter xl:text-[24px] lg:text-[20px] text-[16px] font-normal text-[#000] xl:leading-[59px]">
