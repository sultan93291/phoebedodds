        ...
        <div className="relative z-10 p-[120px]">
          <div className="flex gap-x-[22px]">
            <div className="w-3/5">
              ...
              <p className="font-inter font-normal text-[#FFFFFF] text-[24px] pt-6 pb-12">
            ...
            <div className="w-2/5 mt-10 relative">
              <figure>
                <img src={Banimg1} alt="Banimg1" />
              </figure>
              <div className="rounded-[32px] border border-[#828282] bg-white/20 shadow-[0_2px_16px_rgba(0,0,0,0.08)] backdrop-blur-[25px] absolute bottom-[80px] right-0 py-7 px-7 w-[300px] h-[230px]">
